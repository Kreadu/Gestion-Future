...
// .wrangler/tmp/bundle-ri7U3z/checked-fetch.js
...
// .wrangler/tmp/bundle-ri7U3z/strip-cf-connecting-ip-header.js
    ...
    const Dashboard = () => {
      ...
      const handleOpenCreateEmployee = () => {
        if (!selectedCompanyId) {
          alert('Primero crea o selecciona una empresa para poder agregar empleados.');
          return;
        }
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                <select value={selectedCompanyId} onChange={(e) => setSelectedCompanyId(e.target.value)} style={{ width: '220px' }}>
                  <option value="">{companiesList.length ? 'Selecciona empresa' : 'Sin empresas creadas'}</option>
          ...
          <main style={{ padding: '1.5rem 2rem', flex: 1, display: 'grid', gridTemplateColumns: '260px minmax(0, 1fr) minmax(0, 1fr)', gap: '1.25rem', maxWidth: '1600px', margin: '0 auto', width: '100%' }}>
            ...
            <div className="card">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                {!selectedCompanyId && (
                  <div style={{ padding: '1.5rem 0.5rem', textAlign: 'center', color: '#64748b', fontSize: '12px' }}>
                    Crea una empresa y selecci\xF3nala para empezar a agregar empleados.
                  </div>
                )}
                {selectedCompanyId && employeesList.length === 0 && (
                  <div style={{ padding: '1.5rem 0.5rem', textAlign: 'center', color: '#64748b', fontSize: '12px' }}>
                    Esta empresa a\xFAn no tiene empleados.
                  </div>
                )}
            ...
            <div className="card">
              ...
              <form onSubmit={handleCalculatePayroll} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                <div><label>Primer Nombre *</label><input type="text" placeholder="Nombre 1" value={form.firstName} onChange={e => setForm({...form, firstName: e.target.value})} required /></div>
                <div><label>Segundo Nombre</label><input type="text" placeholder="Nombre 2" value={form.firstName2} onChange={e => setForm({...form, firstName2: e.target.value})} /></div>
                <div><label>Primer Apellido *</label><input type="text" placeholder="Apellido 1" value={form.lastName} onChange={e => setForm({...form, lastName: e.target.value})} required /></div>
                <div><label>Segundo Apellido</label><input type="text" placeholder="Apellido 2" value={form.lastName2} onChange={e => setForm({...form, lastName2: e.target.value})} /></div>
                <div><label>C\xE9dula *</label><input type="text" placeholder="N\xFAmero de c\xE9dula" value={form.taxId} onChange={e => setForm({...form, taxId: e.target.value})} required /></div>
                <div><label>Salario Mensual (COP) *</label><input type="text" placeholder="Ej: 2.500.000" value={form.baseSalaryMonthlyFormatted} onChange={e => setForm({...form, baseSalaryMonthlyFormatted: formatCurrency(e.target.value)})} required /></div>
                <div><label>D\xEDas Trabajados *</label><input type="number" min="1" max="30" placeholder="30" value={form.daysWorked === 0 ? '' : form.daysWorked} onChange={e => setForm({...form, daysWorked: e.target.value})} required /></div>
                <div><label>Horas Extra Diurnas</label><input type="number" placeholder="0" value={form.extraDiurna === 0 ? '' : form.extraDiurna} onChange={e => setForm({...form, extraDiurna: e.target.value})} /></div>
                <div><label>Horas Extra Nocturnas</label><input type="number" placeholder="0" value={form.extraNocturna === 0 ? '' : form.extraNocturna} onChange={e => setForm({...form, extraNocturna: e.target.value})} /></div>
                <div><label>Recargos Nocturnos (Horas)</label><input type="number" placeholder="0" value={form.recargoNocturno === 0 ? '' : form.recargoNocturno} onChange={e => setForm({...form, recargoNocturno: e.target.value})} /></div>
              ...
              <div className="modal-content">
                ...
                <form onSubmit={handleSaveCompany} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                  ...
                  <div style={{ gridColumn: 'span 2' }}>
                    ...
                    <input type="text" placeholder="Ej: Empresa Alfa S.A.S." value={companyForm.name} onChange={e => setCompanyForm({...companyForm, name: e.target.value})} required />
                  </div>

                  <div>
                    <label>NIT *</label>
                    <input type="text" placeholder="Ej: 900123456" value={companyForm.nit} onChange={e => setCompanyForm({...companyForm, nit: e.target.value})} required />
                  </div>

                  <div>
                    <label>DV</label>
                    <input type="text" maxLength="1" placeholder="0-9" value={companyForm.dv} onChange={e => setCompanyForm({...companyForm, dv: e.target.value})} />
                  </div>
                  ...
                  <div>
                    <label>Ciudad *</label>
                    <input type="text" placeholder="Ej: Popay\xE1n" value={companyForm.city} onChange={e => setCompanyForm({...companyForm, city: e.target.value})} required />
                  </div>

                  <div>
                    <label>Direcci\xF3n</label>
                    <input type="text" placeholder="Ej: Calle 5 # 10-20" value={companyForm.address} onChange={e => setCompanyForm({...companyForm, address: e.target.value})} />
                  </div>
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="Ej: Juan P\xE9rez" value={companyForm.contactName} onChange={e => setCompanyForm({...companyForm, contactName: e.target.value})} />
                  </div>
                  ...
                  <div>
                    <label>Email</label>
                    <input type="email" placeholder="Ej: contacto@empresa.com" value={companyForm.email} onChange={e => setCompanyForm({...companyForm, email: e.target.value})} />
                  </div>
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="Ej: Carlos L\xF3pez" value={companyForm.legalRepresentative} onChange={e => setCompanyForm({...companyForm, legalRepresentative: e.target.value})} />
                  </div>
              ...
              <div className="modal-content">
                ...
                <form onSubmit={handleSaveEmployee} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                  <div>
                    ...
                    <input type="text" placeholder="Nombre 1" value={newEmp.firstName} onChange={e => setNewEmp({...newEmp, firstName: e.target.value})} required />
                  </div>
                  <div>
                    <label>Segundo Nombre</label>
                    <input type="text" placeholder="Nombre 2" value={newEmp.firstName2} onChange={e => setNewEmp({...newEmp, firstName2: e.target.value})} />
                  </div>
                  <div>
                    <label>Primer Apellido *</label>
                    <input type="text" placeholder="Apellido 1" value={newEmp.lastName} onChange={e => setNewEmp({...newEmp, lastName: e.target.value})} required />
                  </div>
                  <div>
                    <label>Segundo Apellido</label>
                    <input type="text" placeholder="Apellido 2" value={newEmp.lastName2} onChange={e => setNewEmp({...newEmp, lastName2: e.target.value})} />
                  </div>
                  <div>
                    <label>C\xE9dula / Tax ID *</label>
                    <input type="text" placeholder="N\xFAmero de c\xE9dula" value={newEmp.taxId} onChange={e => setNewEmp({...newEmp, taxId: e.target.value})} required />
                  </div>
                  <div>
                    <label>Cargo / Posici\xF3n</label>
                    <input type="text" placeholder="Ej: Analista Senior" value={newEmp.position} onChange={e => setNewEmp({...newEmp, position: e.target.value})} />
                  </div>
                  <div>
                    <label>Salario Mensual (COP) *</label>
                    <input type="text" placeholder="Ej: 2.500.000" value={newEmp.salaryFormatted} onChange={e => setNewEmp({...newEmp, salaryFormatted: formatCurrency(e.target.value)})} required />
                  </div>
                  <div>
                    <label>Ciudad</label>
                    <input type="text" placeholder="Ej: Popay\xE1n" value={newEmp.city} onChange={e => setNewEmp({...newEmp, city: e.target.value})} />
                  </div>
                  <div>
                    <label>Tel\xE9fono</label>
                    <input type="tel" placeholder="Ej: 3101234567" value={newEmp.phone} onChange={e => setNewEmp({...newEmp, phone: e.target.value})} />
                  </div>
                  <div>
                    <label>WhatsApp</label>
                    <input type="tel" placeholder="Ej: 3101234567" value={newEmp.whatsapp} onChange={e => setNewEmp({...newEmp, whatsapp: e.target.value})} />
                  </div>
...
// .wrangler/tmp/bundle-ri7U3z/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ri7U3z/middleware-loader.entry.ts
